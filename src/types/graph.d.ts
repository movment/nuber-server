...
export interface GetNearybyDriversResponse {
  ok: boolean;
  error: string | null;
...
export interface Mutation {
  ...
  ReportMovment: ReportMovmentResponse;
  RequestEmailVerification: RequestEmailVerificationResponse;
...
export interface ReportMovmentMutationArgs {
  lastOrientation: number | null;
  lastLat: number | null;
  lastLng: number | null;
}
...
export interface ReportMovmentResponse {
  ok: boolean;
  error: string | null;
}
